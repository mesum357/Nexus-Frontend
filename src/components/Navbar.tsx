  ...
  return (
    <div className="flex items-center gap-2">
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="inline-flex shrink-0 items-center justify-center p-2 rounded-full bg-emerald-500/15 hover:bg-emerald-500/25 text-emerald-700 transition-colors"
        aria-label="Download Android app (Google Play build on Expo)"
        title="Google Play / Android"
      >
        {/*
          Google Play mark in a square 24×24 viewBox (Material-style paths).
          The old 512×512 path did not fill the viewBox evenly, so h-6 w-6 scaling looked stretched.
        */}
        <svg
      ...
      <motion.div whileHover={{ scale: 1.08 }} whileTap={{ scale: 0.95 }}>
        <Link
          to="/iphone-app"
          onClick={onNavigate}
          className="inline-flex shrink-0 items-center justify-center p-2 rounded-full bg-primary/10 hover:bg-primary/20 text-primary transition-colors"
