...
const testimonials = [
  {
    ...
    avatar: avatar1,
            quote: "Pakistan Online has transformed how I reach customers. The multi-vendor platform makes it so easy to showcase my products to the entire city."
  },
  {
    name: "Fatima Khan",
    role: "Student & Entrepreneur",
    avatar: avatar2,
            quote: "From taking online courses to selling handmade items, Pakistan Online is my go-to platform. It's like having the whole city in one app!"
  }
];
